...
fname="C:/Users/Borui/Desktop/Predata/試験片あり/_20171018_222208_OK_org1.jpg"
cat=np.array(Image.open(fname).convert('L'))
U,T=denoise(cat,cat)
s=Image.fromarray(uint8(U))
s.save("C:/Users/Borui/Desktop/ROF.jpg")
